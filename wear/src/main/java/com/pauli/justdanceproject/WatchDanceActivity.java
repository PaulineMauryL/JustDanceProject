...
public class WatchDanceActivity extends WearableActivity implements SensorEventListener {
    ...
    private WatchDialogPause dialogPause;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startActivityBR.setCurrentContext(WatchDanceActivity.this);
    ...
    final Runnable sendDataToBroadcast = new Runnable() {
        public void run() {
            ...
            count = 0;
            /* Send Result */
            Intent intent = new Intent(WatchDanceActivity.this, WearService.class);
    ...
    public void stopActivity(){
        sensorManager.unregisterListener(WatchDanceActivity.this);
    ...
    private class CommunicationBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(s_message.equals(BuildConfig.W_pause_activity_start)){
                ...
                dialogPause = new WatchDialogPause(WatchDanceActivity.this);
                dialogPause.create();
